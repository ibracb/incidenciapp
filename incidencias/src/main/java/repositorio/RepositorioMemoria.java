...
/**
 * Implementación de repositorio en memoria utilizando un HashMap
 * para almacenar las entidades. El identificador es una cadena.
 */
public class RepositorioMemoria<T extends Identificable> implements RepositorioString<T> {

	/**
	 * HashMap para almacenar las entidades, donde la clave es el identificador
	 */
